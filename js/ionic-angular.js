...
// running-cordova-apps-on-windows-and-windows-phone-8-1-using-ionic-06angularjs1-and-other-frameworks.aspx
 ...
 *
 * The checkbox behaves like any [AngularJS checkbox](http://docs.06angularjs1.org/api/ng/input/input[checkbox]).
 *
 * @usage
 * ```html
 ...
 * is important, you can read [https://docs.06angularjs1.org/guide/scope](https://docs.06angularjs1.org/guide/scope).
 *
 ...
 *
 * Radio behaves like any [AngularJS radio](http://docs.06angularjs1.org/api/ng/input/input[radio]).
 *
 * @usage
 * ```html
 ...
 *
 * The toggle behaves like any [AngularJS checkbox](http://docs.06angularjs1.org/api/ng/input/input[checkbox]) otherwise.
 *
